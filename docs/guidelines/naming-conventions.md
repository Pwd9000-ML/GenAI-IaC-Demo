...
This article summarizes naming rules and restrictions for Azure resources. For recommendations about how to name resources, see [Recommended naming and tagging conventions](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/azure-best-practices/naming-and-tagging/?wt.mc_id=DT-MVP-5004771).

This article lists resources by resource provider namespace. For a list of how resource providers match Azure services, see [Resource providers for Azure services](https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/azure-services-resource-providers/?wt.mc_id=DT-MVP-5004771).
...
| simGroups | Resource Group | 1-64 | Alphanumeric, underscores and hyphens <br><brStart with alphanumeric |
| simGroups / sims | Sim Group | 1-64 | Alphanumeric, underscores and hyphens <br><brStart with alphanumeric |
