...
variable "private_ip" {
  description = "Not required if frontend_config_private_ip_address_allocation is set to Dynamic. The Private IP Address to use for the Application Gateway."
  type        = string
}
...
variable "waf_enabled" {
  description = "Is the Web Application Firewall be enabled? Allowed values: true or false."
  type        = bool
}
...
variable "key_vault_name" {
  type        = string
  description = "The name of the Key Vault in which to create the Application Gateway."
  default     = "conto-dev-prj-kv"
}
...
variable "key_vault_secret_or_certificate_id" {
  type        = string
  description = "The name of the secret or certificate ID."
}
...
variable "probes" {
  ...
  description = "The probes for the Application Gateway."
}
...
| `key_vault_name` | The name of the key vault who store the certificate. | `string` | `conto-dev-prj-kv` | no |
