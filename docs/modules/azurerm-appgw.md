...
# [Application Gateway Configuration](https://learn.microsoft.com/en-us/azure/application-gateway/)
----------------------------
...
```hcl
module "appgwV2" {
  source                              = "git::ssh://git@ssh.dev.azure.com/v3/Axpo-AXSO/TIM-INFRA-MODULES/azurerm_application_gateway?ref=v1.3.0"
